    ...
    return (
        <div className='dark:bg-[#111329] pt-[120px] overflow-hidden'>
            <div className="w-[80%] mx-auto h-[120px] flex items-center justify-between fixed top-0 left-1/2 transform -translate-x-1/2 z-10">
                ...
                <div className="hidden xl:block xl:flex items-center gap-[20px] text-[10px] 2xl:text-[13px] text-[#1F2428] font-[600] ">
                    <Link to={'/howBuy'}>
                        <p className={`font-[600] ${pathname === "/howBuy" ? 'text-red-500' : 'text-[#1F2428]'}  dark:${pathname === "/howBuy" ? 'text-red-500' : 'text-[#fff]'}`}>
                            {t("navbar.How to buy")}
                        </p>
                    </Link>
                    <Link to={'/sale'}>
                        <p className={`font-[600] ${pathname === "/sale" ? 'text-red-500' : 'text-[#1F2428]'}  dark:${pathname === "/sale" ? 'text-red-500' : 'text-[#fff]'}`}>{t("navbar.Sales")}</p>
                    </Link>
                    <Link to={'/prices'}>
                        <p className={`font-[600] ${pathname === "/prices" ? 'text-red-500' : 'text-[#1F2428]'}  dark:${pathname === "/prices" ? 'text-red-500' : 'text-[#fff]'}`}>{t("navbar.Prices")}</p>
                    </Link>
                    <Link to={'/halp'}>
                        <p className={`font-[600] ${pathname === "/halp" ? 'text-red-500' : 'text-[#1F2428]'}  dark:${pathname === "/halp" ? 'text-red-500' : 'text-[#fff]'}`}>{t("navbar.Help")}</p>
                    </Link>
                    <Link to={'/bonusses'}>
                        <p className={`font-[600] ${pathname === "/bonusses" ? 'text-red-500' : 'text-[#1F2428]'}  dark:${pathname === "/bonusses" ? 'text-red-500' : 'text-[#fff]'}`}>{t("navbar.Bonuses")}</p>
                    </Link>
                    <Link to={'/blog'}>
                        <p className={`font-[600] ${pathname === "/blog" ? 'text-red-500' : 'text-[#1F2428]'}  dark:${pathname === "/blog" ? 'text-red-500' : 'text-[#fff]'}`}>{t("navbar.Blog")}</p>
                    </Link>
                    <Link to={'/shops'}>
                        <p className={`font-[600] ${pathname === "/shops" ? 'text-red-500' : 'text-[#1F2428]'}  dark:${pathname === "/shops" ? 'text-red-500' : 'text-[#fff]'}`}>{t("navbar.shops")}</p>
                    </Link>
                </div>
                <div className="hidden md:block md:flex items-center gap-[30px] justify-center pl-[-20px]">
                    {/* <p className='flex items-center gap-[11px] dark:text-[#fff]'><img src={UserIcon} />Вход</p> */}
                    <select className='rounded-[10px] p-[7px] outline-none' onChange={(e) => changeLanguage(e.target.value)}>
                        <option value="ru">Ru</option>
                        <option value="en">En</option>
                    </select>
                    <ButtonAll name={t("navbar.Connect with us")} />
                </div>
                <div className="hidden md:block w-[8%]" onChange={(e) => e.target.setSwitche(false)}>
                    <Switcher />
                </div>
            ...
            <Outlet />
            <div className="w-[90%] mx-auto text-[#1F2428]">
                <div className="w-[89%] mx-auto md:flex flex-wrap justify-between py-[70px] dark:text-[white] text-center md:text-start">
                    <div className="">
                        <img className='mb-[34px] mx-auto' src={logo} alt="" />
                        <div className="flex gap-[6px] mb-[30px]">
                            <img className='mx-auto' src={whatsup} alt="" />
                            <img className='mx-auto' src={viber} alt="" />
                            <img className='mx-auto' src={chat} alt="" />
                        </div>
                    </div>
                    <div className='mb-[20px]'>
                        <p className='font-bold mb-[15px]'>О компании</p>
                        <p className='text-[14px] mb-[10px]'>Услуги</p>
                        <p className='text-[14px] mb-[10px]'>Цены</p>
                        <p className='text-[14px] mb-[10px]'>Отзывы</p>
                        <p className='text-[14px] mb-[10px]'>Контакты</p>
                        <p className='text-[14px] mb-[10px]'>Вакансии</p>
                        <p className='text-[14px] mb-[10px]'>Соглашение о персональных данных</p>
                        <p className='text-[14px] mb-[10px]'>Условия использования</p>
                    </div>
                    <div className="mb-[20px]">
                        <p className='font-bold mb-[15px]'>О компании</p>
                        <p className='text-[14px] mb-[10px]'>Услуги</p>
                ...
                <hr />
                <p className='text-center text-[13px] py-[35px] dark:text-[white]'>© 2021 Okeypost . Все права защищены.</p>
            </div>
        </div>
    )
}
